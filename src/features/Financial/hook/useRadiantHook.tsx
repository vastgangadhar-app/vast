...
const useRadiantHook = () => {
  ...
  const setRadiantOtp = useCallback(async (transId, mobileNo, shopId, amount, requestType = 'Daily', QRId) => {
console.log( JSON.stringify({
  ...
  "request_type":requestType
    ...
    setIsLoading(true);
    const res = await post({ url: APP_URLS.sendRadiantOtp, data: {
        "trans_id":transId,
        "mobile_no":mobileNo,
        "shop_id": shopId,
        "tot_amount":amount,
  ...
  const setRadiantDynamicOtp = useCallback(async (transId, mobileNo, shopId, amount, qrTransId, reqType) => {
      console.log({
          "trans_id": transId,
          "mobile_no": mobileNo,
          "shop_id": shopId,
