...
export const useLocationHook = () => {
  ...
  const getLocation = useCallback(async () => {
    requestMultiple([
      ...
      if(statuses && statuses[PERMISSIONS.ANDROID.ACCESS_FINE_LOCATION] === RESULTS.GRANTED || statuses[PERMISSIONS.ANDROID.ACCESS_COARSE_LOCATION] === RESULTS.GRANTED){
  ...
  const checkLocationPermissionStatus = useCallback(async () => {
    ...
    if(status && status[PERMISSIONS.ANDROID.ACCESS_FINE_LOCATION] === RESULTS.GRANTED || status[PERMISSIONS.ANDROID.ACCESS_COARSE_LOCATION] === RESULTS.GRANTED){
